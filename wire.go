...
var appSet = wire.NewSet(
    application.NewCrontabTaskApp,
    application.NewUserApp,
)

// srv
var srvSet = wire.NewSet(
    wire.Bind(new(service.IServiceUser), new(*service.UserService)),
    service.NewUserService,
)

// infra
var infraSet = wire.NewSet(
    wire.Bind(new(repository.IReposAUTH), new(*auth.JWTInfra)),
    auth.NewJWTInfra,
    wire.Bind(new(repository.IReposUserMode), new(*dbs.UserModeInfra)),
    dbs.NewUserDBInfra,
)
